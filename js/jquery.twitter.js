...
(function($) {
	...
	*/
	...
	$.fn.getTwitter = function(options) {
		...
		if (o.showHeading) {
			$(this).append('<h2 class="bottom15">'+o.headingText+'</h2>');
		}
		...
		function twitterCallback2(twitters) {
		  ...
		  for (var i=0; i<twitters.length; i++){
			...
			statusHTML.push('<li><div><span>'+status+'</span> <a class="twitt-links" href="http://twitter.com/'+username+'/statuses/'+twitters[i].id_str+'">'+relative_time(twitters[i].created_at)+'</a></div></li>');
		  }
		  var id = '';
		  id = o.id;
