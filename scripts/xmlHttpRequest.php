...
$yourName = 'RK Gulf LLC';
$yourEmail = 'reachme@sarinsoman.com';
$yourSubject = 'Online Enquiry from RK Gulf Website';
$referringPage = 'http://www.rkgulf.com/contactus.php';
...
return stripslashes($nStr);
	...
	$to = $yourName;
	$subject = 'Online Enquiry from RK Gulf Websit : '.cleanPosUrl($_POST['posRegard']);
